...
[^orcheo-skill]: Today, this is enabled by the companion [`Orcheo Skill`](https://github.com/ShaojieJiang/agent-skills), which works well with coding agents such as Codex, Claude Code, and Cursor so users can keep working inside their existing agent subscription instead of burning their own API tokens.
...
If you want to see that progression in action, watch the videos above. If you want to explore Orcheo further, browse the [Orcheo GitHub repo](https://github.com/ShaojieJiang/orcheo) or the [Orcheo documentation](https://orcheo.readthedocs.io/).
